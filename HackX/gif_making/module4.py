...
FPS_DELAY = 30      # milliseconds per frame
# ------------------------------------------
...
def simulate_module4(save_gif=True):
    ...
    while True:
        ...
        # Add frame to GIF list (convert BGR → RGB)
    ...
    frames.append(cv2.cvtColor(final, cv2.COLOR_BGR2RGB))

    # Save as GIF
    if save_gif:
        imageio.mimsave("module4_suction.gif", frames, fps=1000//FPS_DELAY)
        print("✅ GIF saved as 'module4_suction.gif'")
